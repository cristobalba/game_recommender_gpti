...
const model = genAI.getGenerativeModel({
  ...
  systemInstruction: `Eres un trabajador de la plataforma de videojuegos Steam y amante de los 
                        ...
                        sólo entrega los nombres de los juegos con sus descripciones. No entregues una linea
                        inicial del tipo "Aqui tienes juegos que podrian gustarte".` // Instrucción completa
});
...
const formatUserFeedback = async (user) => {
  try {
    ...
    if (aggregatedFeedback) {
      aggregatedFeedback =
        'User feedback on previous recommendations, please consider for future recommendations:\n' +
        aggregatedFeedback;
    } else {
